...
Ported from Josh Carter's Perl IPTCInfo-1.9.pm by Tams Gulcsi
...
Thanks,
Tams Gulcsi <gthomas at fw dot hu>
...
class IPTCInfo(object):
  ...
  def jpegCollectFileParts(self, fh, discardAppParts=False):
    ...
    if app0data is None:
      self.error = 'jpegSkipVariable failed 01'
      self.log(error)
      return None
    ...
    while 1:
      ...
      if not partdata:
        self.error = "JpegSkipVariable failed 02"
        self.log(self.error)
        return None
