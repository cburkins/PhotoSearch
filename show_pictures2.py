...
.cycle-overlay { font-family: tahoma, arial; margin:auto; position: absolute; bottom: 0; width: 70%; z-index: 600; background: black; color: white; padding: 15px; opacity: .3;}
</style>
"""
